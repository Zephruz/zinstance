...
_instances = (_instances or {[globalInstance]={name="global_instance",permanent=true,joinable=false},[defaultInstance]={name="default_instance",permanent=true,joinable=true}})
...
function entMeta:Clone()
	...
	if !(IsValid(ce)) then print("not valid") return end
